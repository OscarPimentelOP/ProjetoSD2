...
/**
 * This class implements the Baggage Reclaim Office that is a service proxy agent thread
 *  that deals with the client request and executes the operations on the Baggage Reclaim Office
