...
/**
 * This class implements the Departure Terminal Transfer Quay Proxy that is a service proxy agent thread
 *  that deals with the client request and executes the operations on the Departure Terminal Transfer Quay
