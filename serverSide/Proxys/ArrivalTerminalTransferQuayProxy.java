...
/**
 * This class implements the Arrival Terminal Transfer Quay Proxy that is a service proxy agent thread
 *  that deals with the client request and executes the operations on the Arrival Terminal Transfer Quay 
