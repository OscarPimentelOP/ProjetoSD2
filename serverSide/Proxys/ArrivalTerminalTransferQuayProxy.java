	...
	/**
	   ...
	   */
	   ...
	   public void run ()
	   {
	      ...
	      try
	      { outMessage = attqInter.processAndReply (inMessage);         // processá-lo
	      }
	   ...
	   */
	   ...
	   {
	      Class<serverSide.Proxys.ArrivalTerminalTransferQuayProxy> cl = null;             // representação do tipo de dados ClientProxy na máquina
	                                                           //   virtual de Java
